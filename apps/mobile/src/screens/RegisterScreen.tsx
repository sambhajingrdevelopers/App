...
export default function RegisterScreen({ navigation }: any) {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>New user registration placeholder.</Text>
      <Pressable style={styles.button} onPress={() => navigation.navigate('CreateProfile')}><Text style={styles.buttonText}>Continue</Text></Pressable>
    </View>
  );
}
